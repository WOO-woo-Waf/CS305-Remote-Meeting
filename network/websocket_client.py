    ...
    async def connect(self):
        ...
        while True:
            try:
                ...
                ui.update_text(f"INIT Response: Success")
                break  # 成功连接后退出循环
    ...
    async def process_server_message(self, data):
        ...
        try:
            ...
            if action == "INIT_ACK":
                ...
                self.rtp_client.client_stream.append(data.get("client_id"))
                self.rtp_client.ui_handler.add_video_window(data.get("client_id"))
